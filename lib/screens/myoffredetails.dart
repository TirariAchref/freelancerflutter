...
import 'package:freelancerflutter/screens/profiledetails.dart';
...
class MMyoffreDetails extends StatefulWidget {
  const MMyoffreDetails(this.id, this.UserId, this.subject, this.description,
  ...
  @override
  State<MMyoffreDetails> createState() => _MMyoffreDetailsState();
}

class _MMyoffreDetailsState extends State<MMyoffreDetails> {
                                      ...
                                      showDialog(
                                        ...
                                        builder: (BuildContext context) {
                                          return const AlertDialog(
                                            title: Text("Offre In progress"),
                                            content: Text(
                                                "Offre still In progress!"),
                                          );
                                        },
                                      );
                                    }
